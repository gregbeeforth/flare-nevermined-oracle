...
describe("createConsumer", () => {
  ...
  it("should use default RPC URL from env var", () => {
    ...
    process.env.FTSO_FEED_IDS =
      "0x01464c522f55534400000000000000000000000,0x014254432f55534400000000000000000000000";
  ...
  it("should use single default feed ID when env var is not set", () => {
    ...
    const ids = "0x01464c522f55534400000000000000000000000".split(",").map((id) => id.trim());
    expect(ids).toHaveLength(1);
    expect(ids[0]).toBe(
      "0x01464c522f55534400000000000000000000000",
    );
  });
});